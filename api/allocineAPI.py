...
class allocineAPI:
    ...
    def get_movies(self, id_cinema, date_str: str, verbose_url=False):
        ...
        while page < totalPages:
            if verbose_url:
                print("URL", URLs.showtime_url(id_cinema, date_str, page + 1), '\n')
...
if __name__ == '__main__':
    ...
    # My Test 
    # path = 'https://www.allocine.fr/_/showtimes/theater-P0671/d-2025-02-07/p-1'
    # req = requests.get(path, params=None)
    req = requests.get(f'https://tastedive.com/api/details?q=the%20great%20gatsby')

    if req.status_code != 200:
        raise
    try:
        test = dict(json.loads(req.text))
        print('************************************************')
        print(test)
    ...
    # data = api.get_showtime("P1699", "2025-02-07")
    # print(data)

    # films = api.get_movies('P0671',"2025-02-07", verbose_url=True)  # Film cité international aujourd'hui
    # for film in films:
    #     print(film)
    ...
    # films = api.get_movies('P0671', "2025-02-07", verbose_url=True)  # Film cité international demain
    # for film in films[:1]:
    #     print(film)
